...
Every result comes from `uv sync --frozen && uv run --frozen python -m reproduction.run` at commit `e8505d6cb1bfa5679eea18690d9a5e8496b46fd9` with one CPU
thread and no GPU. Download the [release manifest](https://huggingface.co/spaces/DineshAI/7UEBX1KU1y/resolve/main/evidence/release_manifest.json)
or rerun the [fail-closed verifier](https://huggingface.co/spaces/DineshAI/7UEBX1KU1y/resolve/main/evidence/code/release_verifier.py).
